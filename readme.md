...
![输入图片说明](https://github.com/csmaxuebin/SOKA/blob/main/picture/1.png)Fig.7 shows the effects of the number of records and the number of attributes in the dataset on the information loss performance of the algorithms, respectively
